function WhatClients() {
  return (
    <section id="reviews" className=" py-5 max-md:min-h-[60vh]  flex flex-col md:flex-row  justify-center md:items-start items-center ">
        ...
        <div className=" z-20 rotate-6 w-[90%] aspect-square md:-translate-x-20 max-md:-mt-[380px] max-w-[450px]  md:translate-y-28 glass-nav rounded-3xl p-5 flex flex-col justify-center items-center gap-5 relative overflow-hidden ">
